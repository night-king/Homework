...
namespace Homework.Migrations
{
    ...
    [Migration("20260724054438_Added_SharedJourney")]
    partial class Added_SharedJourney
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("Homework.Catalog.Medal", b =>
                {
                    b.Property<Guid>("Id")
                        .HasColumnType("uuid");
                    ...
                    b.ToTable("AppMedals", (string)null);
                });

            modelBuilder.Entity("Homework.Catalog.PetForm", b =>
                {
                    ...
                    b.Property<string>("EvolveVideoObjectKey")
                        .HasMaxLength(256)
                        .HasColumnType("character varying(256)");

                    b.Property<int?>("GrowthToNext")
                        .HasColumnType("integer");
                    ...
                    b.Property<string>("SpriteObjectKey")
                        .HasMaxLength(256)
                        .HasColumnType("character varying(256)");

                    b.HasKey("PetSpeciesId", "Level");

                    b.ToTable("AppPetForms", (string)null);
                });

            modelBuilder.Entity("Homework.Catalog.PetSpecies", b =>
                {
                    b.Property<Guid>("Id")
                        .HasColumnType("uuid");
                    ...
                    b.ToTable("AppPetSpecies", (string)null);
                });

            modelBuilder.Entity("Homework.Catalog.RewardItem", b =>
                {
                    b.Property<Guid>("Id")
                        .HasColumnType("uuid");
                    ...
                    b.ToTable("AppRewardItems", (string)null);
                });

            modelBuilder.Entity("Homework.Children.ChildProfile", b =>
                {
                    b.Property<Guid>("Id")
                        .HasColumnType("uuid");
                    ...
                    b.ToTable("AppChildProfiles", (string)null);
                });

            modelBuilder.Entity("Homework.Journeys.Journey", b =>
                {
                    b.Property<Guid>("Id")
                        .HasColumnType("uuid");
                    ...
                    b.Property<Guid>("SharedJourneyId")
                        .HasColumnType("uuid");
                    ...
                    b.HasIndex("SharedJourneyId");

                    b.HasIndex("ChildId", "Status");

                    b.ToTable("AppJourneys", (string)null);
                });

            modelBuilder.Entity("Homework.Journeys.JourneyBackpackItem", b =>
                {
                    ...
                    b.HasKey("JourneyId", "RewardItemId");

                    b.ToTable("AppJourneyBackpackItems", (string)null);
                });

            modelBuilder.Entity("Homework.Journeys.JourneyPetStage", b =>
                {
                    b.Property<Guid>("JourneyId")
                        .HasColumnType("uuid");
                    ...
                    b.HasKey("JourneyId", "Level");

                    b.ToTable("AppJourneyPetStages", (string)null);
                });

            modelBuilder.Entity("Homework.Journeys.SharedJourney", b =>
                {
                    b.Property<Guid>("Id")
                        .HasColumnType("uuid");
                    ...
                    b.ToTable("AppSharedJourneys", (string)null);
                });

            modelBuilder.Entity("Homework.Scoring.DailyScore", b =>
                {
                    b.Property<Guid>("Id")
                        .HasColumnType("uuid");
                    ...
                    b.ToTable("AppDailyScores", (string)null);
                });

            modelBuilder.Entity("Homework.Tasks.DailyTask", b =>
                {
                    b.Property<Guid>("Id")
                        .HasColumnType("uuid");
                    ...
                    b.Property<Guid?>("SourceTemplateItemId")
                        .HasColumnType("uuid");
                    ...
                    b.ToTable("AppDailyTasks", (string)null);
                });

            modelBuilder.Entity("Homework.Tasks.JourneyTaskTemplateItem", b =>
                {
                    b.Property<Guid>("Id")
                        .HasColumnType("uuid");
                    ...
                    b.Property<bool>("RewardIsRandom")
                        .HasColumnType("boolean");
                    ...
                    b.HasIndex("JourneyId", "DayOfWeek");

                    b.HasIndex("SharedJourneyId", "DayOfWeek");

                    b.ToTable("AppJourneyTaskTemplateItems", (string)null);
                });
            ...
            modelBuilder.Entity("Homework.Catalog.PetForm", b =>
                {
                    b.HasOne("Homework.Catalog.PetSpecies", null)
                        .WithMany("Forms")
            ...
            modelBuilder.Entity("Homework.Journeys.JourneyBackpackItem", b =>
                {
                    b.HasOne("Homework.Journeys.Journey", null)
                        .WithMany("Backpack")
