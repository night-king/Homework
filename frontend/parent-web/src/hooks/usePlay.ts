...
import {
  getActiveJourney, getPlayDailyBoard, getBackpack, getCollection, getWeekStrip,
...
export function usePlayMutations(childId: string, _journeyId?: string) {
  ...
  return {
    ...
    complete: useMutation({
      ...
      onSuccess: () => { void invalidateBoard(); void invalidateBackpack(); void invalidateWeekStrip() },
      onError: onErr,
    }),
