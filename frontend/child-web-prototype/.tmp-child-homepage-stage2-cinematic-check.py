...
(() => {
  ...
  const metrics = {
    ...
    wingHeightRatio: form.wings ? form.wings.height / form.body.length : 0,
    jawRatio: form.jaw ? form.jaw.length / form.head.length : 0,
    chestRatio: form.body.chest ?? 0,
    waistRatio: form.body.waist ?? 1,
  ...
  const checks = {
    ...
    wingHeightRatio: metrics.wingHeightRatio >= thresholds.wingHeightRatio,
    jawRatio: metrics.jawRatio >= thresholds.jawRatio,
    chestRatio: metrics.chestRatio >= thresholds.chestRatio,
    waistRatio: metrics.waistRatio <= thresholds.waistRatio,
